(function () {
    ...
    var module = angular.module('TextCoder.charts', []);
    ...
    module.directive('TextCoderVis', function () {

        var TextCoderVis = function (scope, $element, attrs, onClicked, groupColor) {
            ...
            self.render = function (dataTable) {
                ...
                if (primary) {
                    ...
                    config.bindto = $element.find('.TextCoder-vis-render-target')[0];
        ...
        function link(scope, $element, attrs) {
            if (!scope._TextCoderVis) {
                ...
                var vis = scope._TextCoderVis = new TextCoderVis(scope, $element, attrs, onClicked, scope.groupColors);
        ...
        return {
            ...
            link: link,
            transclude: true,
            template: '<div class="TextCoder-vis-render-target"></div>' +
