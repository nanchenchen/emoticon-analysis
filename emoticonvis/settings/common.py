"""
Django settings for emoticonvis project.
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'emoticonvis.apps.base.context_processors.google_analytics',
)
...
LOCAL_APPS = (
    'emoticonvis.apps.base',
    'emoticonvis.apps.api',
    'emoticonvis.apps.corpus',
    'emoticonvis.apps.importer',
    'emoticonvis.apps.enhance',
)
...
if DEBUG:
    LOGGING['loggers']['emoticonvis']['level'] = 'DEBUG'
...
COMPRESS_PRECOMPILERS = (
    ...
    ('text/less', 'emoticonvis.precompilers.LessFilter'),
)
...
REST_FRAMEWORK = {
    'VIEW_DESCRIPTION_FUNCTION': 'emoticonvis.apps.api.drf.get_view_description',
}
######### END REST FRAMEWORK
